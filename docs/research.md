...
- цветные отрезки шкалы должны быть пропорциональны реальным годам, иначе положение ползунка не совпадает с видимой отметкой года;
- подписи на такой шкале нужно показывать выборочно: близкие границы периодов физически не помещаются без наложения.
